...
class ExposeAccountKeyIssueTest {
    ...
    fun `Expose issue with account keys api`() {
        ...
        val signAlgorithm1 = SignatureAlgorithm.ECDSA_P256
        val hashAlgorithm1 = HashAlgorithm.SHA3_256
        val pair1 = Crypto.generateKeyPair(signAlgorithm1)
        ...
        val createAccountResult = flow.simpleFlowTransaction(
            ...
            arguments {
                ...
                arg { uint8(signAlgorithm1.index) }
        ...
        val signAlgorithm2 = SignatureAlgorithm.ECDSA_P256
        val hashAlgorithm2 = HashAlgorithm.SHA3_256
        val pair2 = Crypto.generateKeyPair(signAlgorithm1)
        ...
        val addKeyResult = flow.simpleFlowTransaction(newAccountAddress, signer1) {
            script {
                """
                    transaction(publicKey: String, signAlgorithm: UInt8, hashAlgorithm: UInt8, weight: UFix64) {
                        prepare(signer: AuthAccount) {
                            signer.keys.add(
                                publicKey: PublicKey(
                                    publicKey: publicKey.decodeHex(),
            ...
            arguments {
                ...
                arg { uint8(signAlgorithm2.index) }
